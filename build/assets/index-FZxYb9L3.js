import{r as Z}from"./index-CmUHEo0m.js";var j={};function G(r){if(typeof window>"u")return;const l=document.createElement("style");return l.setAttribute("type","text/css"),l.innerHTML=r,document.head.appendChild(l),r}Object.defineProperty(j,"__esModule",{value:!0});var e=Z;function J(r){return r&&typeof r=="object"&&"default"in r?r:{default:r}}var a=J(e);G(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;
