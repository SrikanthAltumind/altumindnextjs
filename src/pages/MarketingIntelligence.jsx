...
const MarketingIntelligence = () => {
  return (
    ...
    <Banner/>
     ...
     <section id='section2'>
       ...
       <div className='font-raleway dark:text-white'>
         <div className='text-center mb-8 max-w-[700px] mx-auto'>
             <h2 className='custom-sub-heading'>Our Marketing Intelligence Process</h2>
             <p className='custom-gradient-text'>Your Roadmap to Data-Driven Success</p>
         </div>
         <TimeLineFlow/> 
       </div>
     </section>
     ...
     <section id='section4'>
       <TechStackSlider title="Tech Stack" heading="Powering Insights with Advanced Technology"/>
     </section>
         ...
         <div className='w-[90%] mx-auto font-raleway'>
             <div className='text-center mb-20 space-y-3 max-w-[750px] mx-auto'>
                 ...
                 <h2 className='custom-gradient-text'>
                  {/* Your Trusted Partner in Marketing Intelligence */}
                  Drive Data-Driven Success through Marketing Intelligence Solutions
                  </h2>
             </div>
             <WhyChooseUs/>
         </div>
       ...
       <div className='font-raleway text-center dark:text-white'>
             <div className='w-[90%] max-w-[750px] mx-auto text-center mb-10'>
               <div className='text-center space-y-3 mb-10 sm:mb-10'>
                 ...
                 <p className='custom-gradient-text'>Transforming Industries with Data-Driven Marketing Intelligence Solutions</p>
                 <p className='text-[13px] mb-5 font-medium'>Our Marketing Intelligence services are crafted to meet the unique needs and challenges of various industries, enabling businesses to harness actionable insights and optimize marketing strategies for growth and innovation.</p>
               </div>
             </div>
             <IndustriesSlider/>
       </div>
