...
const servicesMenu = [
  ...
  {id:'section5', tabId:'tab5', name:'Benefits'},
  ...
  return (
    <div className="dark:bg-darkTheme flex flex-col gap-24 lg:gap-28">
        ...
        <div className='text-center font-raleway space-y-3 mb-10'>
            ...
            <p className=' font-extrabold text-3xl  lg:text-4xl text-transparent w-fit mx-auto bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue'>Architect of Your Digital Success Story</p>
        </div>
            <WhyAltumind/>
        </div>
        </section>
      ...
      <section id="section5">
          <div className="text-center space-y-2 mb-20 font-raleway">
            ...
            <p className="font-extrabold text-3xl  lg:text-4xl text-transparent w-fit mx-auto bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue">Harmonizing Your IT with Business Goals</p>
          </div>
          <SettingUpForSuccess/>
        </section>
        <section id="section6">
