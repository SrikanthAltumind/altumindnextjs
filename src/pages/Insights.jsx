...
const Insights = () => {
  ...
  return (
    <>
      <Helmet>
        {/* For SEO  */}
        <title>Insights | Latest Trends, Analysis, and Expert Perspectives</title>
        <meta
          name="description"
...
<div className='bg-LightBlue md:h-[300px] max-md:py-10 flex md:flex-row flex-col-reverse justify-between items-center gap-y-10 font-raleway px-4 md:px-10 lg:px-28'>
     ...
     <div>
       <img className="lg:h-[260px] h-[230px] mx-auto" src="https://alt-digital-cms.s3.ap-south-1.amazonaws.com/Insights_ae8cc4fd04.svg" alt="A glowing light bulb with decorative elements, surrounded by a black and blue design, symbolizing creativity and innovation." />
     </div>
   </div>
      {/* <div className="flex w-full justify-center items-center p-5 lg:h-[200px]">
      https://alt-digital-cms.s3.ap-south-1.amazonaws.com/Insights_ec79102db9.svg
        <p
