...
const servicesMenu = [
  ...
  {id:'section4', tabId:'tab4', name:'Testimonials'},
...
const DataAnalytics = () => {
  return (
    <div className="dark:bg-darkTheme flex flex-col gap-24 lg:gap-28">
       ...
       <section id="section2">services</section>
       <section id="section3">
       <div className="bg-[#F3F9FF] dark:bg-gradient-to-b from-[#031848] to-darkTheme py-10">
        <div className='text-center font-raleway space-y-3 mb-10'>
            ...
            <p className=' font-extrabold text-3xl  lg:text-4xl text-transparent w-fit mx-auto bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue'>Turning Data into Your Competitive Edge</p>
        </div>
      <WhyAltumind/>
      </div>
      </section>
      ...
      <section id="section5"><TechStack/></section>
      <section id="section6">
          <div className="text-center space-y-2 mb-20 font-raleway">
            <p className="text-sm md:text-base dark:text-white text-black dark:font-normal font-semibold">Industries We Serve</p>
            <p className="font-extrabold text-3xl  lg:text-4xl text-transparent w-fit mx-auto bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue">Tailored Solutions Across Diverse Sectors</p>
          </div>
          <SettingUpForSuccess/>
        </section>
            <GetStarted/>
