...
const PerformanceTesting = () => {
  ...
  return (
      ...
      <Helmet>
        {/* SEO */}
        <meta name="title" content="Performance Testing Services for Faster, Smarter Software" />
        ...
        <div className='-mt-24 lg:-mt-28 flex flex-col gap-24 lg:gap-28'>
          ...
          <section id='section2'>
            <div className='w-[90%] mx-auto'>
              <div className='text-center mb-8 max-w-[800px] mx-auto font-raleway'>
                  <h2 className='custom-sub-heading'>Our Performance Testing Services</h2>
                  <p className='custom-gradient-text'>Performance QA services that drive excellence</p>
              </div>
            <DevelopmentServices/>
            </div>
          </section>
          ...
          <section id='section3'>
            <div className="w-[90%] text-center font-raleway space-y-3 mb-10 max-w-[800px] mx-auto">
              ...
              <p className='custom-gradient-text'>Strategic Performance Engineering for Maximum System Reliability</p>
            </div>
            <TimeLineFlow/>
          </section>

          <section id='section4'>
            <TechStackSlider title="Tech Stack" heading="Powering Intelligent Performance Testing"/>
          </section>
              ...
              <div className='font-raleway'>
                  <div className='w-[90%] text-center mb-10 mx-auto'>
                      ...
                      <h2 className='custom-gradient-text max-w-[700px]'>
                        {/* Unleashing Digital Performance Potential */}
                        Your Trusted Performance Testing Company for Reliable Results
                        </h2>
                  </div>
                  <WhyChooseUs/>
              </div>
          ...
          <section id='section6'>
            <div className='w-[90%] max-w-[950px] mx-auto'>
              <div className="text-center font-raleway space-y-3 mb-10">
                ...
                <p className='custom-gradient-text'>Transforming Performance Challenges into Competitive Wins</p>
              </div>
              <SettingUpForSuccess/>
            </div>
          </section>
