...
const DigitalIntelligence = () => {
  return (
    ...
    <Banner/>
     ...
     <section id='section2'>
        <div className='w-[90%] mx-auto font-raleway dark:text-white'>
           <div className='text-center mb-10 max-w-[750px] mx-auto'>
               <p className='custom-sub-heading'>Our Digital Intelligence Services</p>
               <p className='custom-gradient-text'>Empowering Your Digital Journey with Tailored Services</p>
           </div>
           <DevelopmentServices/>
         </div>
       </section>
       ...
       <div className='font-raleway dark:text-white'>
         <div className='text-center mb-8 max-w-[700px] mx-auto'>
             <h2 className='custom-sub-heading'>Our Digital Intelligence Process</h2>
             <p className='custom-gradient-text'>The Roadmap to Digital Intelligence Success</p>
         </div>
         <TimeLineFlow/> 
       </div>
     </section>
     ...
     <section id='section4'>
       <TechStackSlider title="Tech Stack" heading="Powering Digital Intelligence with Cutting-Edge Tools"/>
     </section>
       ...
       <div className='bg-LightBlue dark:bg-DarkBackground dark:text-white py-10'>
         <div className='w-[90%] mx-auto font-raleway'>
             <div className='text-center mb-20 space-y-3 max-w-[750px] mx-auto'>
                 ...
                 <p className='custom-gradient-text'>Transform Challenges Into Opportunities</p>
             </div>
             <WhyChooseUs/>
         </div>
       </div>
     ...
     <div className="text-center space-y-3 max-w-[750px] mx-auto mb-20 font-raleway">
       ...
       Unlocking Measurable Growth Through Insightful Data
       </p>
     </div>
         <SettingUpForSuccess/> 
     </section>
       ...
       <div className='font-raleway text-center dark:text-white'>
             <div className='w-[90%] max-w-[750px] mx-auto text-center mb-10'>
               <div className='text-center space-y-3 mb-10 sm:mb-10'>
                 ...
                 <p className='custom-gradient-text'>Redefining Industries with Tailored Digital Intelligence Services</p>
                 <p className='text-[13px] mb-5 font-medium'>Our specialized Digital Intelligence services cater to the distinct requirements of diverse industries, offering actionable insights to optimize user experiences, drive innovation, and enhance decision-making.</p>
               </div>
             </div>
             <IndustriesSlider/>
       </div>
