...
const servicesMenu = [
  ...
  {id:'section5', tabId:'tab5', name:'Industries'},
  ...
  return (
    <div className="dark:bg-darkTheme flex flex-col gap-24 lg:gap-28">
        ...
        <div className="flex flex-col -mt-24 lg:-mt-28 gap-24 lg:gap-28">
          ...
          <section id="section3">
            <div className="bg-[#F3F9FF] dark:bg-gradient-to-b from-[#031848] to-darkTheme py-10">
              <div className='text-center font-raleway space-y-3 mb-10'>
                ...
                <p className=' font-extrabold text-3xl  lg:text-4xl text-transparent w-fit mx-auto bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue'>Elevating Businesses Through Smart Engineering</p>
              </div>
              <WhyAltumind/>
            </div>
          </section>
          ...
          <section id="section6"> <TechStack/></section>
          <GetStarted/>
