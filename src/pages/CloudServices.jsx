  ...
  return (
    <div className="dark:bg-darkTheme flex flex-col gap-24 lg:gap-28">
      ...
      <p className='text-sm md:text-base dark:text-white text-black dark:font-normal font-semibold'>Our Partnership Ecosystem</p>
            <p className=' font-extrabold w-fit mx-auto text-3xl  lg:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue'>Elite Partners Behind Our Cloud Innovation</p>
            </div>
       <SolutionPartners/>
      </section>
      ...
      <div className='text-center font-raleway space-y-3 mb-10'>
            ...
            <p className=' font-extrabold text-3xl  lg:text-4xl text-transparent w-fit mx-auto bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue'>Making Cloud Work for You</p>
        </div>
      <WhyAltumind/>
      </section>
        <section>
        ...
        <section>
          <div className="text-center space-y-2 mb-20 font-raleway">
            ...
            <p className="font-extrabold text-3xl  lg:text-4xl text-transparent w-fit mx-auto bg-clip-text bg-gradient-to-r from-gradientBlue  via-gradientGreen to-gradientBlue">Adaptive Solutions for Modern Success</p>
          </div>
          <SettingUpForSuccess/>
        </section>
        <GetStarted/>
