...
useEffect(()=> {
  ...
  return (
      <div className='w-full flex lg:h-[600px] md:h-[450px] h-[300px]'>
            ...
            {bannerData.map(item=> 
                ...
                <div className='min-h-[calc(100vh-40px)] sm:min-h-[calc(100vh-300px)] sm:flex justify-center  md:px-5 max-sm:pt-10'>
                    <div className='basis-[50%] flex items-center justify-center'>
                        <img className='max-w-[300px] md:max-w-[400px] lg:max-w-[450px] object-contain' src={flyingRocket} alt="rocket"/>                    
                    </div>
