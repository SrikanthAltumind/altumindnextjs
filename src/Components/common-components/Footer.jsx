...
const Footer = () => {
      ...
      <div className="dark:bg-darkTheme dark:text-white">
        <div className="w-[90%] mx-auto font-montserrat text-sm font-medium flex flex-wrap gap-9 lg:gap-10 my-8 justify-between">
          ...
          <div className="space-y-8 max-md:mt-5 font-medium">
            <img src={logo} alt="AltumindGlobal" className="w-[170px]" />
            ...
            <div className="py-3 flex items-center gap-4">
                  ...
                  >
                    <svg
                      className="w-8 h-8 text-white bg-black rounded-full p-1 cursor-pointer hover:scale-[1.1]"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
  ...
  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m9 5 7 7-7 7"/>
             ...
             <div className="flex flex-wrap gap-9 lg:gap-10">
             <div className="">
              <p className="text-lg font-semibold pb-2">We Serve</p>
              <ul className="space-y-3 dark:font-normal">
                <li>
                  <Link to="/industries/bfsi-fintech">BFSI</Link>
                </li>
                <li>
                  <Link to="/industries/digital-commerce">Digital Commerce</Link>
                </li>
                ...
                <li>
                  {" "}
                  <Link to="/industries/green-sustainability">Sustainability</Link>
                </li>
                <li>
                  <Link to="/industries/edtech">Edtech</Link>
                </li>
                 <li>
                  <Link to="/industries/internet-saas">SaaS</Link>
                </li>
                {/* <li>
            ...
            <div className="">
              <p className="text-lg font-semibold pb-2">Company</p>
              <ul className="space-y-3 dark:font-normal">
                <li>
