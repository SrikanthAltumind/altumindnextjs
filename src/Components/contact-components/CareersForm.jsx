...
const contentSection = {
  ...
  imgUrl:
    "https://alt-digital-cms.s3.ap-south-1.amazonaws.com/Careers_Compressify_io_7817557ffb.webp",
};
...
const CareersForm = () => {
  ...
  const validationSchema = yup.object({
    ...
    companyName: yup
      .string()
      .matches(/^[A-Za-z ]+$/, "Enter only alphabet")
      .test("leading-space", "Cannot start with space", (value) =>
  ...
  return (
    <div
      className={`w-[90%] md:w-[95%] max-w-[1200px] mx-auto dark:text-white flex flex-col md:flex-row shadow-custom-shadow`}
    >
      <div className="basis-[35%] shrink-0 lg:basis-[30%] p-5 lg:p-10 pb-2 font-raleway bg-LightBlue dark:bg-DarkBackground flex flex-col items-center md:items-start gap-4">
        <img
          src={contentSection?.imgUrl}
          className="w-36 h-36 lg:w-52 lg:h-52 object-cover bg-merald-200"
        />
        <p className="custom-gradient-text md:mx-0  max-md:text-center text-2xl lg:text-3xl">
        ...
        <svg
          className="w-14 h-12 text-secondary"
          aria-hidden="true"
