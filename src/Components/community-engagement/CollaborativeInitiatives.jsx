  ...
  return (
    <div className=' font-raleway dark:text-white'>
        <div className='w-[90%] max-w-[1000px] gap-10 mx-auto flex flex-col items-center sm:flex-row '>
            <div className='basis-[50%]  grow max-lg:text-center'>
                ...
                <Link to='/' className='group text-xs lg:text-base text-secondary underline underline-offset-2 decoration-1 font-semibold flex gap-2 items-center w-fit max-lg:mx-auto'>
